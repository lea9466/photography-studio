    ...
    content: (
      <>
        ...
        <ul className="mt-4 list-disc space-y-2 ps-6">
          ...
          <li>
            <strong>Vercel</strong> — אחסון ואירוח (hosting) של האתר והשירות, לרבות ניתוב
            דומיינים מותאמים אישית
          </li>
          <li>
            <strong>Resend</strong> ו-<strong>Mailjet</strong> — שליחת הודעות דוא&quot;ל (מייל
            עסקאות והתראות)
          </li>
          <li>
            <strong>SUMIT</strong> — סליקת תשלומים וניהול מנויים. פרטי כרטיס האשראי
            מוזנים ומעובדים ישירות אצל ספק הסליקה ואינם נשמרים אצלנו.
          </li>
        </ul>
        <p className="mt-4">
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mt-4">
          <strong>גלריות לקוח:</strong> מרגע שגלריה נשלחת ללקוח/ה, היא נעולה לעריכה
          ונשמרת למשך 60 יום (ברירת מחדל, ניתנת לקיצור מראש על ידי הצלם/ת). בטרם המחיקה
          נשלחות התראות דוא&quot;ל ללקוח/ה ולצלם/ת. בתום התקופה הגלריה, התמונות וכל קובצי
          האחסון הנלווים נמחקים לצמיתות באופן אוטומטי.
        </p>
      </>
    ),
  },
        ...
        <article aria-labelledby="privacy-title">
          <header className="mb-10 animate-fade-in">
            ...
            <p className="mt-2 text-sm text-[--muted]">
              עודכן לאחרונה: <time dateTime="2026-09-16">{LAST_UPDATED}</time>
            </p>
          </header>
