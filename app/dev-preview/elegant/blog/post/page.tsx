...
import { ElegantBlogPostPage } from '@/components/photographer/themes/elegant/ElegantBlogPostPage'

/**
 * Throwaway preview route for the elegant-theme single BLOG POST page —
 * mirrors app/dev-preview/dark/blog/post/page.tsx's exact mock shape. A
...
export default function ElegantBlogPostPreviewPage() {
  return (
    <>
      <ElegantBlogPostPage
        ...
        post={{
          ...
          date: '2 באוגוסט 2026',
          coverUrl: 'https://picsum.photos/seed/elegant-blog-2/1920/1200',
          images: [
            'https://picsum.photos/seed/elegant-blog-2-extra-1/1400/1000',
            'https://picsum.photos/seed/elegant-blog-2-extra-2/1400/1000',
          ],
        }}
        postPath="/dev-preview/elegant/blog/post"
        prevPost={{
          id: 'p1',
          title: 'איך לבחור את הרגעים הנכונים לצילום',
          coverUrl: 'https://picsum.photos/seed/elegant-blog-1/400/300',
          href: '/dev-preview/elegant/blog/post',
        }}
        nextPost={{
          id: 'p3',
          title: 'תיעוד הריון: מה כדאי לדעת מראש',
          coverUrl: 'https://picsum.photos/seed/elegant-blog-3/400/300',
          href: '/dev-preview/elegant/blog/post',
        }}
      />
    </>
