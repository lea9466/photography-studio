...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          ברוכים הבאים ל‑STG. תקנון ותנאי שימוש אלה (&quot;התקנון&quot;) מסדירים את
  ...
  },
  {
    ...
    content: (
      <p>
        STG מספקת כלים לניהול גלריות צילום, שיתוף תמונות עם לקוחות, בניית אתר
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          את/ה שומר/ת על כל הזכויות בתוכן שאת/ה מעלה. בעצם העלאת תוכן, את/ה מעניק/ה ל‑STG
          רישיון מוגבל, לא בלעדי וללא תמלוגים, לאחסן, להציג, לעבד ולהפיץ את התוכן
  ...
  {
    id: 'ip',
    title: 'קניין רוחני של STG',
    content: (
      <p>
        כל הזכויות בפלטפורמה, בעיצוב, בקוד, בלוגו, בשם המסחרי ובחומרי השיווק של STG
        שייכות לחברה או לבעלי הרישיון שלה. אין להעתיק, לשכפל, להפיץ או ליצור יצירות
  ...
  },
  {
    ...
    content: (
      <p>
        STG לא תישא באחריות לנזקים עקיפים, תוצאתיים, אובדן רווחים, אובדן נתונים
        ...
        <article aria-labelledby="terms-title">
          <header className="mb-10 animate-fade-in">
            ...
            <p className="mt-4 text-base leading-relaxed text-[--muted] sm:text-lg">
              מסמך זה מגדיר את תנאי השימוש בפלטפורמת STG לצלמים, סטודיואים
              ולקוחותיהם.
            </p>
