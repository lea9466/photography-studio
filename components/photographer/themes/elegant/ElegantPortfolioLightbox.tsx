...
import styles from './ElegantPortfolioLightbox.module.css'

export type ElegantPortfolioLightboxProps = {
...
/**
 * Elegant-theme portfolio lightbox — identical mechanics/markup to
 * Classic/Dark/ModernPortfolioLightbox.tsx (the old renderer's
 * `.pg-lightbox` recipe is genuinely shared across every theme, see those
 * components' doc comments). Kept as its own file per the "one folder per
 * theme" convention rather than literally shared.
 */
export function ElegantPortfolioLightbox({
  photos,
  openIndex,
  onClose,
  onPrev,
