...
import styles from './ElegantBlogShareLinks.module.css'
...
export type ElegantBlogShareLinksProps = {
  shareUrl: string
  postTitle: string
  accentColor: string
...
/**
 * Elegant-theme post share row — identical behavior/markup to
 * Classic/Dark/ModernBlogShareLinks.tsx (copy-link / WhatsApp / email,
 * "copied!" flash as local component state) — see those components' doc
 * comments. Kept as its own file per the "one folder per theme" convention
 * rather than literally shared.
 */
export function ElegantBlogShareLinks({ shareUrl, postTitle, accentColor, language }: ElegantBlogShareLinksProps) {
