...
import styles from './DarkBlogShareLinks.module.css'
...
export type DarkBlogShareLinksProps = {
  shareUrl: string
  postTitle: string
  accentColor: string
...
/**
 * Dark-theme post share row — identical behavior/markup to
 * Classic/ModernBlogShareLinks.tsx (copy-link / WhatsApp / email, "copied!"
 * flash as local component state) — see those components' doc comments.
 * Kept as its own file per the "one folder per theme" convention rather than
 * literally shared.
 */
export function DarkBlogShareLinks({ shareUrl, postTitle, accentColor, language }: DarkBlogShareLinksProps) {
