...
import styles from './DarkPortfolioContactCard.module.css'

export type DarkPortfolioContactCardProps = {
  title: string | null
...
export function DarkPortfolioContactCard({
  title,
  description,
  accentColor,
  homepagePath,
  language,
}: DarkPortfolioContactCardProps) {
