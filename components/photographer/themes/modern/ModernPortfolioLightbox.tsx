...
import styles from './ModernPortfolioLightbox.module.css'

export type ModernPortfolioLightboxProps = {
...
/**
 * Modern-theme portfolio lightbox — identical mechanics/markup to
 * ClassicPortfolioLightbox.tsx (the old renderer's `.pg-lightbox` recipe is
 * genuinely shared across every theme, see that component's doc comment).
 * Kept as its own file per the "one folder per theme" convention rather than
 * literally shared.
 */
export function ModernPortfolioLightbox({
  photos,
  openIndex,
  onClose,
  onPrev,
