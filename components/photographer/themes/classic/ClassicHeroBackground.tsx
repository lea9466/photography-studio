...
type ClassicHeroBackgroundProps = {
...
// fallback visible instead of showing a broken/black player.
export function ClassicHeroBackground({ desktopImages, mobileImages, videoUrl, alt }: ClassicHeroBackgroundProps) {
