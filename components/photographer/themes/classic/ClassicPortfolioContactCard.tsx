...
import styles from './ClassicPortfolioContactCard.module.css'

export type ClassicPortfolioContactCardProps = {
  title: string | null
...
export function ClassicPortfolioContactCard({
  title,
  description,
  accentColor,
  homepagePath,
  language,
}: ClassicPortfolioContactCardProps) {
