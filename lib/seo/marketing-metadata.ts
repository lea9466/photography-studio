...
export const MARKETING_FEATURES = [
  ...
  },
  {
    ...
    description:
      'סביבה מאובטחת לניהול בחירת התמונות מול הלקוח — לאלבום ולעיבוד, ומסירה קלה ומהירה בסוף.',
  },
  {
    title: 'התמונות פתוחות בנטפרי',
    description:
      'הגלריות הפרטיות אושרו בנטפרי, כולל התמונות עצמן — הלקוחות רואים הכל רגיל, בלי חסימות.',
  },
] as const
