...
export function buildPrivateGalleriesAnnouncementEmail(input: { name: string }): {
  ...
  const contentHtml = `
    ...
    ${luxeCheckList([
      ...
      ['הכול אוטומטי — אין מה לרשום', 'המערכת שומרת מי בחר מה. את רק לוחצת "הורד תמונות נבחרות", ואחרי העריכה מעלה בטאב "מעובדות"'],
      ['בלי מיילים חוזרים שנאבדים', 'הכול נשאר בגלריה אחת — לא מתפזר בין המייל ל-Drive'],
      ['התמונות מוגנות לאורך כל הבחירה', 'הלקוח רואה גרסה בסימן מים, בלי הורדה — עד שאת מאשרת אחרת'],
    ...
    ${luxeStepCards([
      ...
      [
        'הלקוח בוחר בעצמו',
        'הוא מסמן על התמונה עצמה — רשימה לאלבום ורשימה לעיבוד, כל אחת בנפרד, לפי המכסה שהגדרת.',
        '✅',
      ],
      [
        'מורידה את הבחירות — אוטומטית, באיכות מלאה',
        'ברגע שהוא סיים מגיע אלייך מייל. נכנסת, לוחצת "הורד תמונות נבחרות", ומקבלת ZIP עם בדיוק מה שבחר — בקבצים המלאים שהעלית, מסודרים לאלבום ולעיבוד. אין מה לרשום ואין מה להתאים.',
        '📥',
      ],
      [
        'מעלה מעובדות בטאב "מעובדות"',
        'אחרי העריכה — מעלה את התמונות המוכנות בטאב "מעובדות" של אותה גלריה. הלקוח מקבל מייל ומוריד את כולן בקליק, באיכות שאישרת.',
        '✨',
      ],
    ])}
  ...
  return {
    ...
    text: [
      ...
      '3. הלקוח בוחר בעצמו — מסמן על התמונה עצמה, רשימה לאלבום ורשימה לעיבוד בנפרד.',
      '4. מורידה את הבחירות — אוטומטית, באיכות מלאה: לוחצת "הורד תמונות נבחרות", ומקבלת ZIP עם בדיוק מה שבחר, מסודר לאלבום ולעיבוד. אין מה לרשום ואין מה להתאים.',
      '5. מעלה מעובדות בטאב "מעובדות" של אותה גלריה — הלקוח מקבל מייל ומוריד את כולן בקליק, באיכות שאישרת.',
      '',
    ...
    html: renderLuxeEmail({
      preheader:
        'הבחירות של הלקוח הן הקבצים עצמם — מורידה בדיוק מה שבחר באיכות מלאה, אוטומטית, בלי רשימות מספרים. הראשונה חינם.',
      contentHtml,
    }),
  }
}
